...
console.log('�� Finding Love Notes from David to Nitzan')
console.log('')

async function findLoveNotes() {
  try {
    ...
    // Build the query for messages from David to Nitzan across full timeline
    const { data: messages, error } = await supabase
      ...
      .gte('readable_date', '2015-01-01')  // From 2015 onwards
      .lte('readable_date', '2025-12-31')  // Up to 2025
      .order('readable_date', { ascending: false })
      .limit(10000)  // Get all messages from the full timeline

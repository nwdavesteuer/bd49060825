#!/usr/bin/env python3
"""
Comprehensive Nitzan Message Extractor
Extracts ALL messages between David and Nitzan from all relevant chats,
filtering out group conversations and ensuring we get the actual direct messages.
"""
...
class ComprehensiveNitzanExtractor:
    def __init__(self):
    ...
    def extract_all_nitzan_messages(self, output_file=None):
        """Extract all messages between David and Nitzan from all relevant chats."""
        print("🔍 Finding all chats involving Nitzan...")
...
def main():
    try:
        extractor = ComprehensiveNitzanExtractor()
